...
class StoreSreen extends StatefulWidget {
  var data;
  String text;

  StoreSreen({this.data});

  @override
  _StoreSreenState createState() => _StoreSreenState();
}

class _StoreSreenState extends State<StoreSreen> {
  @override
