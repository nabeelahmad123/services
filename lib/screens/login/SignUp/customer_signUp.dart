...
class _CustomerSignUpState extends State<CustomerSignUp> {
  ...
  Future RegistrationUser() async {
    Uri APIURL = Uri.parse("https://electricgear.com.au/api/customer/register");
    Map mapdata = {
      'username': textEditingControllerUserName.text,
      'email': textEditingControllerEmail.text,
      'password': textEditingControllerPassword.text,
      'confirm_password': textEditingControllerConfirmPassword.text,
    };
    ...
    if (response.statusCode == 200) {
      ...
      if ((data['error']['username']) != null) {
        Toast.show("This User name already taken", context,
